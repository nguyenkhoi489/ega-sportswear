...
$body = $('body'),
  ...
  inputs.each(function () {
    ...
    name = name.replace(/^(.*)\[]$/, '$1'); // offers additional name formatting from invoker
    ...
    value = t.val(); // if name is composite, try to recreate missing structure
...
function yith_wcan_dependencies_handler_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
function yith_wcan_filter_term_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }
...
function yith_wcan_filter_term_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
function yith_wcan_filter_range_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }
...
function yith_wcan_filter_range_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var yith_wcan_filter_range_YITH_WCAN_Filter = /*#__PURE__*/function () {
  ...
  yith_wcan_filter_range_createClass(YITH_WCAN_Filter, [{
    ...
    key: "initDependencies",
    value: function initDependencies() {
      var $unlimitedCheck = this.$range.find('[name*="unlimited"]'); // manage unlimited check
...
function yith_wcan_filter_iterableToArrayLimit(arr, i) { var _i = arr == null ? null : typeof Symbol !== "undefined" && arr[Symbol.iterator] || arr["@@iterator"]; if (_i == null) return; var _arr = []; var _n = true; var _d = false; var _s, _e; try { for (_i = _i.call(arr); !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }
...
function yith_wcan_filter_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }
...
function yith_wcan_filter_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var YITH_WCAN_Filter = /*#__PURE__*/function () {
  ...
  yith_wcan_filter_createClass(YITH_WCAN_Filter, [{
    ...
    value: function initTermSearch() {
      ...
      $termSearch.selectWoo(select2_args); // on term changes redraw Customize terms section
    ...
    value: function afterTaxonomyChange() {
      var $termSearch = this.$filter.find('.term-search').first(); // clear terms select when taxonomy is changed

      $termSearch.find('option').remove().end().change(); // handle changes to Customize Terms description
    ...
    value: function customizeTermsNotice() {
      ...
      var $taxonomySelect = this.$filter.find('.taxonomy').first(),
          ...
          taxonomy = $taxonomySelect.val(),
          filterDesign = $filterDesign.val(); // show Colors & Labels notice
    ...
    value: function initErrorsHandling() {
      ...
      this.$filter.on('change keydown', ':input', function () {
        ...
        if ($input.hasClass('validation-error')) {
          ...
          $input.removeClass('validation-error').removeClass('required-field-empty'); // remove any error message
    ...
    value: function save() {
      ...
      var preset_id = this.preset.getId(),
          ...
          prev_filter_id = $prev_filter.length ? $prev_filter.attr('id').replace('filter_', '') : -1; // send terms.
    ...
    value: function validate() {
      var layout = this.preset.$layout.find(':checked').val(),
          ...
          title = $title.val(); // horizontal layout needs title for each filter
    ...
    value: function open() {
      // fix title
      this.$toggleTitle.find('.title-arrow').removeClass('yith-icon-arrow-right-alt').addClass('yith-icon-arrow-down-alt'); // animate content and return promise
    ...
    value: function close() {
      ...
      // fix title
      this.$filter.find('.yith-toggle-title').find('.title-arrow').addClass('yith-icon-arrow-right-alt').removeClass('yith-icon-arrow-down-alt'); // animate content and return promise
...
var YITH_WCAN_Preset = /*#__PURE__*/function () {
  ...
  yith_wcan_preset_createClass(YITH_WCAN_Preset, [{
    ...
    value: function initFilters() {
      ...
      var $filters = this.$filtersContainer.find('.filter-row'); // filter specific init
